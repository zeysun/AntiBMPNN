#This running script is adapted and edited from ProteinMPNN/protein_mpnn_run.py
import argparse
import os.path
...
def main(args):
    ...
    noise=args.backbone_noise
    print('Backbone_noise:', noise)
    ...
    with torch.no_grad():
        ...
        for ix, protein in enumerate(dataset_valid):
            ...
            if args.score_only:
                ...
                ali_file = base_folder + '/seqs/' + batch_clones[0]['name'] + "|" + str(args.model_name) + '|N-' +str(args.backbone_noise) + '|T-' + str(args.sampling_temp) + '.fa' 
                        ...
                        for j in range(NUM_BATCHES):
                            ...
                            for b_ix in range(BATCH_COPIES):
                                ...
                                if b_ix == 0 and j==0 and temp==temperatures[0]:
                                    ...
                                    f.write('>{}, score={}, global_score={}, fixed_chains={}, designed_chains={}, {}={}, git_hash={}, seed={}\n{}\n'.format(name_, native_score_print, global_native_score_print, print_visible_chains, print_masked_chains, print_model_name, args.model_name, commit_str, seed, native_seq))
                                start = 0
                                end = 0
                                list_of_AAs = []
                                for mask_l in masked_chain_length_list:
